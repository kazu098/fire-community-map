#!/usr/bin/env python3
"""Seed member_profiles/member_tags/member_links for the fifth tag-display batch (1 member: 浮雲).

Same upsert pattern as load_member_profiles.py / load_member_profiles_batch2.py / batch3 / batch4.
"""
...
def main() -> int:
    ...
    parser.add_argument("--self-intros", default="tmp/tag_display_self_intros_batch5.json")
