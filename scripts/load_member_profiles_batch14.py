#!/usr/bin/env python3
"""Seed member_profiles/member_tags/member_links for the fourteenth tag-display batch (1 member: もずく).

もずく has no formal self-introduction post (template with 【ニックネーム】 etc.)
in the Discord self-intro channel -- only casual chat messages. Profile fields
(avatar, self_intro_*) are therefore sourced directly here instead of via
tmp/tag_display_self_intros_batchN.json, using the Discord avatar URL and the
master profile spreadsheet (ID 2: 北海道/30代前半/フリーランスとニートの中間).

Same upsert pattern as load_member_profiles.py / batch2-13.
"""
...
PROFILE = {
    "nickname": "もずく",
    "avatar_url": "https://cdn.discordapp.com/avatars/1390284975328333937/039b232e8789fbe3fa59f027b8ba122b.png?size=128",
...
MEMBER_LINKS: dict[str, list[dict[str, str]]] = {
    "もずく": [
        {"label": "note", "url": "https://note.com/mzk_mzk"},
    ],
}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Seed batch 14 of member_profiles/member_tags/member_links.")
