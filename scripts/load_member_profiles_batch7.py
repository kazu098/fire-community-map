#!/usr/bin/env python3
"""Seed member_profiles/member_tags/member_links for the seventh tag-display batch (2 members: echo(えこー), そわか).

Same upsert pattern as load_member_profiles.py / load_member_profiles_batch2.py / batch3 / batch4 / batch5 / batch6.
"""
...
MEMBER_TAGS: dict[str, dict[str, list[str]]] = {
    ...
    "そわか": {
        "investment_style": ["WealthNavi", "ドル建てリタイアメントインカム"],
        "fire_status": ["FIRE済"],
        "mbti": ["ISTJ-A"],
        "skill": [],
        "interest": ["旅行", "アートスクール", "宝塚"],
    },
}
...
def main() -> int:
    ...
    parser.add_argument("--self-intros", default="tmp/tag_display_self_intros_batch7.json")
