...
```
🐾 かず さん、みかん さん、さとりーまん さん、ドロリッチ さんがマッチしましたにゃ！
みなさんとも「土曜午前」が空いているみたいです。
...
以前は「よければ集まってお話ししてみてください。（開催するかどうかはみなさんにお任せします）」という説明文を毎回付けていたが、通知のたびに情報量が多いという指摘を受け、空き時間を伝える一文だけに短縮した。
